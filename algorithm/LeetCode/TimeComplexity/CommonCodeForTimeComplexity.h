...
#ifndef TIMECOMPLEXITY_COMMONCODEFORTIMECOMPLEXITY_H
#define TIMECOMPLEXITY_COMMONCODEFORTIMECOMPLEXITY_H
#include <iostream>
#include <cassert>
...
void CommonCodeForTimeComplexity(){
...
#endif //TIMECOMPLEXITY_COMMONCODEFORTIMECOMPLEXITY_H
